...
export default function AddMobile() {
    ...
    function sendData(e){
        ...
        axios.post("http://localhost:8081/hotels/addmobile", newMobile).then(()=>{
        ...
        <div>
            ...
            <div id='sec1'>
                ...
                <form onSubmit={sendData} id="form-hotels">
                    ...
                    <Link id='submit-button' to="/TaxiReservationConfirm" style={{textDecoration:'none'}}><strong>SUBMIT</strong></Link>
                </form>
